  ...
  *::after {
  ...
  .hero {
    ...
    grid-template-areas: "content visual" "trends trends";
    gap: 48px 48px;
    align-items: center;
    min-height: 82vh;
  ...
  .hero::before {
    ...
    position: absolute;
    inset: 0;
    background: radial-gradient(ellipse 60% 50% at 20% 50%, rgba(59, 130, 246, .08), transparent);
    pointer-events: none
  }
  ...
  .terminal-window {
    ...
    overflow: hidden;
    box-shadow: 0 0 40px rgba(59, 130, 246, .08), var(--shadow)
  }
  ...
  [data-theme="light"] .hero-search-widget {
  ...
  [data-theme="light"] .hero-result-item {
  ...
  [data-theme="light"] .hero-result-item:hover {
  ...
  [data-theme="light"] .trending-chip {
    background: rgba(79, 70, 229, 0.06);
  ...
  .hero-inline-search-box:focus-within {
    border-color: var(--accent);
    box-shadow: 0 0 0 3px var(--accent-glow)
  }

  .hero-inline-search-box input {
    flex: 1;
    background: none;
    border: none;
    outline: none;
  ...
  .hero-inline-search-box input::placeholder {
    color: var(--text3)
  }

  .hero-inline-search-box input[type=search]::-webkit-search-cancel-button {
    display: none
  }
  ...
  .hero-trends-cards::-webkit-scrollbar {
    height: 4px
  }

  .hero-trends-cards::-webkit-scrollbar-track {
    background: transparent
  }

  .hero-trends-cards::-webkit-scrollbar-thumb {
  ...
  .hcard:hover {
    ...
    box-shadow: 0 12px 36px rgba(59, 130, 246, .18)
  }
  ...
  [data-theme="light"] .hcard-desc-box {
    background: rgba(79, 70, 229, .04);
    border-color: rgba(79, 70, 229, .1)
  }

  .hcard-desc-box strong {
    color: var(--text2);
    font-weight: 600
  }
  ...
  [data-theme="light"] .hcard-solution {
    background: rgba(79, 70, 229, .04);
    border-color: rgba(79, 70, 229, .15)
  }

  .hcard-solution-title {
    font-size: .73rem;
    font-weight: 700;
    color: var(--accent);
    display: flex;
  ...
  [data-theme="light"] .subcat-card:hover {
  ...
  .errors-section {
    ...
    z-index: 1;
    padding: 28px 0 72px;
    background: linear-gradient(180deg, transparent, rgba(59, 130, 246, .03)50%, transparent)
  }
  ...
  [data-theme="light"] .error-table tbody tr:hover {
    background: rgba(79, 70, 229, .06)
  }
  ...
  [data-theme="light"] .error-table tbody tr:nth-child(even) {
  ...
  .modal-overlay.open .modal {
    ...
    box-shadow: 0 24px 80px rgba(0, 0, 0, .7), 0 0 0 1px var(--border), 0 0 60px var(--accent-glow)
  }

  [data-theme="light"] .modal-overlay.open .modal {
    box-shadow: 0 24px 60px rgba(79, 70, 229, .18), 0 0 0 1px rgba(79, 70, 229, .15)
  }
  ...
  .modal-close {
    ...
    cursor: pointer;
    color: var(--text2);
    transition: color var(--tr), border-color var(--tr), background var(--tr), transform .15s ease
  }
  ...
  @media(max-width:900px) {
    .hero {
      ...
      grid-template-areas: "content" "visual" "trends";
      min-height: auto;
  ...
  .search-dropdown {
    ...
    border-radius: var(--radius);
    overflow: hidden;
    box-shadow: 0 12px 48px rgba(0, 0, 0, .55), 0 0 0 1px rgba(59, 130, 246, .08);
  ...
  [data-theme="light"] .search-dropdown {
    ...
    scrollbar-color: rgba(79, 70, 229, .3) rgba(0, 0, 0, .05)
  }
  ...
  [data-theme="light"] .sd-item:hover,
  [data-theme="light"] .sd-item:focus {
  ...
  [data-theme="light"] .skel {
    background: linear-gradient(90deg, rgba(79, 70, 229, .06) 25%, rgba(79, 70, 229, .12) 50%, rgba(79, 70, 229, .06) 75%);
    background-size: 200% 100%;
    animation: skelShimmer 1.4s ease infinite
  }
  ...
  .skeleton-row {
    opacity: 0;
    animation: skelFadeIn .25s ease forwards
  }
  ...
  .cmd-copy-btn.copied {
    ...
    background: rgba(74, 222, 128, .12);
    animation: copyPop .2s cubic-bezier(.34, 1.56, .64, 1)
  }
  ...
  [data-theme="light"] .modal-win-ver {
  ...
  /* --- COMPREHENSIVE RESPONSIVITY OVERHAUL --- */
